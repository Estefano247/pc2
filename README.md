...
│   │       ├── AuthBar.jsx            # Barra superior (email + login/logout)
...
├── supabase/
│   ├── migrations/001_schema.sql      # Migración completa del backend
...
|-------|---------|-------|-----------|
| Carrito | `__tests__/cart.test.js` | 7 | add, remove, cantidad, total, localStorage |
| Errores | `__tests__/errors.test.js` | 7 | traducción de errores Supabase → usuario |
| Componentes | `__tests__/components.test.jsx` | 7 | ErrorBoundary, NavSidebar, AuthBar, Supabase client |
...
Ver `AUDITORIA.md` para el detalle completo de seguridad y calidad.  
Estado: **16/16 riesgos corregidos** ✅
